    ...
    <section className="py-20 bg-gradient-to-b from-seashell to-white">
      <div className="container px-4 mx-auto md:px-6">
        ...
        >
          ...
          >
            <Award className="text-terracotta" size={36} />
          </motion.div>
        ...
        <div className="grid grid-cols-1 gap-12 mb-20 lg:grid-cols-3">
          ...
          >
            <div className="relative">
              ...
              <motion.div 
                ...
                className="absolute flex px-6 py-3 space-x-4 transform -translate-x-1/2 rounded-full shadow-lg -bottom-6 left-1/2 bg-white/95 backdrop-blur-sm"
              >
                {Object.entries(founder.social).map(([platform, url]) => (
                  <motion.a
                    ...
                    className="flex items-center justify-center w-12 h-12 transition-all duration-300 border rounded-full bg-seashell hover:bg-terracotta hover:text-seashell border-void/10"
                  >
          ...
          >
            <div className="space-y-8">
              {/* Name and Role */}
              <div>
                <h3 className="mb-4 text-4xl font-bold md:text-5xl font-heading text-void">
                  {founder.name}
                </h3>
              ...
              <motion.div
                ...
                className="p-8 border-l-4 bg-gradient-to-r from-terracotta/5 to-gold/5 rounded-2xl border-terracotta"
              >
                <div className="flex items-start space-x-4">
                  <Quote className="flex-shrink-0 mt-1 text-terracotta" size={24} />
                  <p className="text-xl italic leading-relaxed text-void/80">
                    "{founder.philosophy}"
                  </p>
                </div>
              </motion.div>
              ...
              <motion.div
                ...
                className="p-6 bg-white border shadow-sm rounded-2xl border-void/10"
              >
                <h4 className="flex items-center mb-4 text-xl font-semibold text-void">
                  <Sparkles className="mr-2 text-gold" size={20} />
                  Areas of Expertise
                </h4>
                <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                  {founder.expertise.map((skill, index) => (
                    ...
                    >
                      ...
                      <span className="text-void/70">{skill}</span>
                    </motion.div>
                  ))}
                </div>
              </motion.div>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="p-12 text-center bg-gradient-to-r from-void to-charcoal rounded-3xl text-seashell"
        >
          <h3 className="mb-6 text-2xl font-semibold md:text-3xl font-heading">
            A <span className="text-gold">Lifetime Commitment</span> to Transformative Storytelling
          </h3>
          <p className="max-w-3xl mx-auto text-lg leading-relaxed text-seashell/80">
